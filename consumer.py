...
host = "tcps://ems1.swim.faa.gov:55443"  # Use the TCPS scheme and the secure port
username = "gear.twinhawk.co"
password = "Bke2fbKgTcKycCYdvBrPDw"
vpn_name = "TFMS"
queue_name = "gear.twinhawk.co.TFMS.9e3be232-071b-4763-8299-9add28baef3e.OUT"  # The queue where you want to receive messages
